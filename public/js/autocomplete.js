...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function initializeAutocomplete(input) {
    ...
    autocomplete.addListener("place_changed", function () {
      ...
      if (!place.geometry) {
        (0,_notifications__WEBPACK_IMPORTED_MODULE_0__.showNotification)("Erro", "Nenhuma informação de localização disponível para o local inserido.", "error");
        return;
      }
      // Você pode usar place.geometry.location para obter a latitude e longitude
      console.log("Local selecionado:", place.geometry.location.toString());
      (0,_notifications__WEBPACK_IMPORTED_MODULE_0__.showNotification)("Sucesso", "Local selecionado: " + place.geometry.location.toString(), "success");
    });
  }
