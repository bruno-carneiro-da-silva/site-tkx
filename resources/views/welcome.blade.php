                    ...
                    <div class="col-lg-6 col-12 text-container">
                        ...
                        <div class="row mt-4 align-items-center">
                            <div class="col-auto mb-4">
                                <h2 class="text-white">+ 1200
                                    <span class="d-block mt-2 ride">Corridas</span>
                                </h2>
                            </div>
                            <div class="col d-flex justify-content-start mb-4 profile-pictures">
                                <img src="images/woman-profile.jpeg" alt="Ícone Perfil 1" class="small-img border border-white border-2" />
                                <img src="images/profile.jpeg" alt="Ícone Perfil 2" class="small-img ms-2 border border-white border-2" />
                                <img src="images/customer.jpeg" alt="Ícone Perfil 2" class="small-img ms-2 border border-white border-2" />
                            </div>
                            <p>
                                Já completamos mais de <strong style="color: var(--primary-color)">1200</strong> corridas tanto para empresas quanto para motoristas autônomos.
                                Assim como, conectamos mais de 500 motoristas com empresas de transporte. Já registramos
                                mais de 1200 corridas no aplicativo tkx mobilidade inteligente.
                            </p>
                        </div>
                    </div>

                    <div class="col-lg-6 col-12 d-flex align-items-center justify-content-center position-relative image-container">
                        <img src="images/iPhoneSpaceBlackFront.jpg" class="black-front img-fluid" alt="Imagem 2">
                        <img src="images/iPhoneSpaceDeepPurpleFront.jpg" class="purple-front img-fluid ms-3" alt="Imagem 1">
                    </div>
                </div>
            </div>
        </section>
